...
//2020年3月4日
Windowsにて、二企業の仕分けの比較を行いたいという話があり、今まで作っていたコードを参考に新たなプログラムを作成した。
WinCompareディレクトリに入っている。

//2020年3月5日
Winディレクトリのappについて、支点が変な位置に出てくるのを修正した。
WinCompareディレクトリのappについて、売上の方の頂点の大きさを調整した
